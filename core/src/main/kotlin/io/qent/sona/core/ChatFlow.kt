        ...
        try {
            ...
            while (responseMessage.hasToolExecutionRequests()) {
                ...
                for (toolRequest in responseMessage.toolExecutionRequests()) {
                    ...
                    emit(currentState.copy(messages = messagesWithToolsResponse, isStreaming = false))
                }

                emit(currentState.copy(messages = currentState.messages + placeholder, isStreaming = true))
            ...
            model.chat(request, object : StreamingChatResponseHandler {
                override fun onPartialResponse(partialResponse: String) {
                    ...
                    if (lastIndex >= 0) {
                        ...
                        emit(currentState.copy(messages = msgs, isStreaming = true))
                    }
                }
